...
attractions_data_15 = merged_data[merged_data['user_id'] == 15]
...
attractions_15_df = pd.DataFrame(merged_data_15,
                                 columns=['attraction_id', 'attraction_name', 'ratings', 'ratings', 'no_of_ratings',
                                          'attraction_type',
                                          'description', 'Latitude', 'Longitude', 'city', 'keywords', 'List Index_x',
                                          'Recommendation Score', 'rating'])

print("------------------- first 20 attractions for user 15 -------------------")
