...
df = pd.read_csv("Cairo_Final_Clean_Updated.csv", encoding='latin1')
...
def get_recommendations(RestaurantName, n, cosine_sim=similarity):
    ...
    print(restaurant_index, RestaurantName)
...
top_restaurants_df, _ = get_recommendations(restaurant_name, number_of_recommendations)
